...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(/*! ./js/app.js */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Box = __webpack_require__(/*! ./Box */ 158);
	...
	var createBoxes = function createBoxes(num) {
	  var boxes = [];
	  for (var i = 0; i < num; i++) {
	    var number = Math.floor(Math.random() * num);
	    var color = 255 - Math.floor(255 * (i / num));
	...
	var BoxApp = (function (_React$Component) {
	  _inherits(BoxApp, _React$Component);
	
	  function BoxApp(props) {
	    _classCallCheck(this, BoxApp);
	
	    _get(Object.getPrototypeOf(BoxApp.prototype), 'constructor', this).call(this, props);
	    this.state = {
	      size: 60,
	      length: 10,
	      boxes: boxes
	  ...
	  _createClass(BoxApp, [{
	    key: 'sortByColor',
	    value: function sortByColor() {
	      var new_boxes = this.state.boxes.sort(function (box_a, box_b) {
	    ...
	    key: 'sortByRandom',
	    value: function sortByRandom() {
	      var new_boxes = shuffle(this.state.boxes);
	      this.setState({ boxes: new_boxes });
	    }
	  }, {
	    ...
	    value: function renderBoxes() {
	      ...
	      var Boxes = this.state.boxes.map(function (box, index) {
	        var shift = {
	        ...
	        return _react2['default'].createElement(
	          _reactMotion.Motion,
	          { style: { top: (0, _reactMotion.spring)(shift.top), left: (0, _reactMotion.spring)(shift.left) }, key: box.id },
	          function (shift) {
	            return _react2['default'].createElement(_Box2['default'], { box: box, shift: shift });
	          }
	        );
	      });
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.sortByColor.bind(this) },
	          'Sort by color'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.sortByNumber.bind(this) },
	          'Sort by number'
	        ),
	        _react2['default'].createElement(
	          'button',
	          { onClick: this.sortByRandom.bind(this) },
	          'Sheffle'
	        ),
	        _react2['default'].createElement(
	          'label',
	        ...
	        _react2['default'].createElement('input', { type: 'number', name: 'row', min: '1', onChange: this.handleNumberChange.bind(this) }),
	        _react2['default'].createElement(
	          'div',
	...
	_react2['default'].render(_react2['default'].createElement(BoxApp, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! c:/Users/squall/AppData/Roaming/npm/~/node-libs-browser/~/process/browser.js */ 4)))

/***/ },
/* 4 */
/*!************************************************************************************!*\
  !*** c:/Users/squall/AppData/Roaming/npm/~/node-libs-browser/~/process/browser.js ***!
  \************************************************************************************/
	...
	var Box = (function (_React$Component) {
	  ...
	  _createClass(Box, [{
	    ...
	    value: function render() {
	      ...
	      var gray = this.props.box.color;
	      var backgroundColor = "rgb(" + gray + "," + gray + "," + gray + ")";
	      return _react2["default"].createElement(
	        "div",
	        { style: _extends({}, style.box, size, this.props.shift, { backgroundColor: backgroundColor }) },
	        this.props.box.number
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reorderKeys = __webpack_require__(/*! ./reorderKeys */ 172);
	...
	var _spring2 = __webpack_require__(/*! ./spring */ 173);
	
	var _spring3 = _interopRequireDefault(_spring2);
	
	exports.spring = _spring3['default'];
	
	var _presets2 = __webpack_require__(/*! ./presets */ 174);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noVelocity = __webpack_require__(/*! ./noVelocity */ 162);
	
	var _noVelocity2 = _interopRequireDefault(_noVelocity);
	
	var _hasReachedStyle = __webpack_require__(/*! ./hasReachedStyle */ 163);
	
	var _hasReachedStyle2 = _interopRequireDefault(_hasReachedStyle);
	
	var _mergeDiff = __webpack_require__(/*! ./mergeDiff */ 164);
	
	var _mergeDiff2 = _interopRequireDefault(_mergeDiff);
	
	var _animationLoop = __webpack_require__(/*! ./animationLoop */ 165);
	
	var _animationLoop2 = _interopRequireDefault(_animationLoop);
	
	var _zero = __webpack_require__(/*! ./zero */ 161);
	
	var _zero2 = _interopRequireDefault(_zero);
	
	var _updateTree = __webpack_require__(/*! ./updateTree */ 168);
	
	var _deprecatedSprings2 = __webpack_require__(/*! ./deprecatedSprings */ 170);
	
	var _deprecatedSprings3 = _interopRequireDefault(_deprecatedSprings2);
	
	var _stripStyle = __webpack_require__(/*! ./stripStyle */ 171);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _performanceNow = __webpack_require__(/*! performance-now */ 166);
	
	var _performanceNow2 = _interopRequireDefault(_performanceNow);
	
	var _raf = __webpack_require__(/*! raf */ 167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var now = __webpack_require__(/*! performance-now */ 166)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _presets = __webpack_require__(/*! ./presets */ 174);
